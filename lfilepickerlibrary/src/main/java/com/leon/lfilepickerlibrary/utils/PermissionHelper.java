 ...
 *
 * @Override public void doAfterGrand(String... permission) {}
 * @Override public void doAfterDenied(String... permission) {}
...
public class PermissionHelper {
    private static final int REQUEST_PERMISSION_CODE = 0x124;
    private Object mContext;
    private PermissionListener mListener;//权限处理监听器
    private List<String> mPermissionList;//权限列表
